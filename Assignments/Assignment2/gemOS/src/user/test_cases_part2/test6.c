...
int main (u64 arg1, u64 arg2, u64 arg3, u64 arg4, u64 arg5) {
    ...
    if(!pid){
        ...
        //read 100 bytes
        char buff8[101];
        printf("%d\n",_read(fd[0],buff8,100,72));

        //write 100 bytes
        char buff9[101]="JoCKyTkC0Put9xOJAyoLV19vb3KqKeLxWjYBRPh0zsPFG4vmAicMef7zsxk5JhvgdnkVSR3TSxs3BO2YAe4zzehqfQAZaqN2hVod";
        printf("%d\n",_write(fd[1],buff9,100,76));
    ...
    printf("%d\n",_write(fd[1],buff,3000,84));

    //read 2000 bytes
    char buff1[2001];
    printf("%d\n",_read(fd[0],buff1,2000,88));
