...
int become_debugger(void *addr)
{
	return _syscall1(SYSCALL_BECOME_DEBUGGER, (long)addr);
}

int set_breakpoint(void *addr, int flag)
{
	return _syscall2(SYSCALL_SET_BREAKPOINT, (u64)addr, (u64)flag);	
}
